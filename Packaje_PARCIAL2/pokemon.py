...
ancho_ventana_1 =  600 
alto_ventana_1 = 500
posicion_ventana_1_x =  50
posicion_ventana_1_y =  150
...
img_rect = imagen.get_rect(center=(ancho_ventana//2, posicion_titulo_y))
...
while flag == True:         
    ...
    ventana.blit(imagen, (img_rect, posicion_ventana_1_y))
